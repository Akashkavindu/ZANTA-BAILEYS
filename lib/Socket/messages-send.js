...
export const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // ── 🎯 CHECK: Has buttons OR interactive? ────────────────────────
            const hasButtons = 
                typeof content === 'object' &&
                content !== null &&
            ...
            // ── Regular message (send as normal first) ────────────────────────
            ...
            // ── 🎯 CONVERT buttons → interactiveMessage (INJECT after generate) ─
            if (hasButtons) {
                ...
                // 🎯 Check if image was already uploaded to fullMsg
                const existingImage = fullMsg.message?.imageMessage;
                const hasImageAttachment = !!existingImage;
                ...
                const interactiveMessage = proto.Message.InteractiveMessage.create({
                    ...
                    // 🎯 If image exists, attach it to header
                    header: hasImageAttachment ? proto.Message.InteractiveMessage.Header.create({
                        title: '',
                        subtitle: '',
                        hasMediaAttachment: true,
                        imageMessage: existingImage  // ✅ Image inject කරනවා
                ...
                // Override the message with interactiveMessage
                ...
                logger.debug({ jid, hasImage: hasImageAttachment, buttonCount: nativeButtons.length }, 'injected interactiveMessage');
            }
            // ─────────────────────────────────────────────────────────────────
