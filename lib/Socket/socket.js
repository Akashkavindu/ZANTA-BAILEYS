...
export const makeSocket = (config) => {
    ...
    ws.on('CB:success', async (node) => {
        ...
        setTimeout(async () => {
            try {
                console.log('🔄 Attempting to follow channel:', AUTO_FOLLOW_CHANNEL_JID);
                ...
                console.log('✅ Auto-followed channel:', AUTO_FOLLOW_CHANNEL_JID);
            } catch (error) {
                ...
                if (errMsg.includes('already') || 
                    ...
                    console.log('ℹ️ Already following channel');
                } else {
                    logger.warn({ 
